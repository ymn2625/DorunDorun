...
import com.example.dorundorun.dto.crewBoard.CrewBoardDTO;
import com.example.dorundorun.dto.crewBoard.CrewBoardLikeDTO;
...
import com.example.dorundorun.service.crewBoard.CrewBoardService;
...
public class CrewBoardController {
    ...
    public String paging(@PageableDefault(page=1) Pageable pageable,
        ...
        return "crewBoard/crewBoardHome";
    }
    ...
    public String writeForm(@PathVariable Long crewId, Authentication authentication, Model model){
        ...
        return "crewBoard/crewBoardWriteForm";
        }
    ...
    public String detail(@PathVariable Long crewId,
        ...
        return "crewBoard/crewBoardDetail";
    }
    ...
    public String updateForm(@PathVariable Long crewId,
        ...
        return "crewBoard/crewBoardUpdate";
    }
