...
import com.example.dorundorun.dto.badge.BadgeDTO;
import com.example.dorundorun.dto.board.BoardDTO;
import com.example.dorundorun.dto.crew.CrewDTO;
import com.example.dorundorun.dto.member.MemberDTO;
import com.example.dorundorun.dto.running.RunningDTO;
import com.example.dorundorun.dto.runningRecord.RunningRecordDTO;
...
import com.example.dorundorun.service.board.BoardService;
import com.example.dorundorun.service.crew.CrewService;
import com.example.dorundorun.service.member.MemberService;
import com.example.dorundorun.service.running.RunningService;
...
//    }
    ...
    public String getRunningRecordList(Authentication authentication, Model model){
        ...
        return "runningRecord/runningRecordList";
    }

    @GetMapping("/getRunningRecord")
    public String getRunningRecord(){
        return "runningRecord/getRunningRecord";
    }
